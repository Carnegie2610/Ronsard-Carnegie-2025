...
export default function Footer() {
  return (
    <footer className="w-full bg-black/40 backdrop-blur-2xl text-white relative overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10 font-body">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full overflow-hidden relative border border-white/20 shadow-md">
                <Image src="/assets/r-home-landing.jpg" alt="DJOUMESSI Ronsard Carnegie" fill sizes="56px" className="object-cover" />
              </div>
              <h3 className="font-heading text-xl font-bold text-white tracking-wide">DJOUMESSI R. Carnegie</h3>
            </div>
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="https://github.com/RonsardCarnegie" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="p-2.5 rounded-full border border-gray-700 text-gray-400 hover:text-white hover:border-white transition-all duration-300 hover:scale-110">
                <Github size={18} />
              </a>
              <a href="#" aria-label="LinkedIn" className="p-2.5 rounded-full border border-gray-700 text-gray-400 hover:text-white hover:border-white transition-all duration-300 hover:scale-110">
                <Linkedin size={18} />
              </a>
              <a href="#" aria-label="Twitter" className="p-2.5 rounded-full border border-gray-700 text-gray-400 hover:text-white hover:border-white transition-all duration-300 hover:scale-110">
                <Twitter size={18} />
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h4 className="font-heading text-lg font-bold text-white mb-6 uppercase tracking-wider">Contact</h4>
            <ul className="flex flex-col gap-5 text-gray-400">
              ...
              <li className="flex items-center gap-4">
                ...
                <a href="mailto:contact@ronsardcarnegie.com" className="hover:text-white transition-colors">contact@ronsardcarnegie.com</a>
              </li>
              <li className="flex items-center gap-4">
        ...
        {/* Divider */}
        <hr className="border-[#1F2937] w-full my-10" />
